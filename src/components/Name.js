...
export default function Name() {
  ...
  const j = {
    initial: {
      strokeDasharray: 212.7,
      strokeDashoffset: 212.7,
    },
    animate: {
      strokeDashoffset: 0,
      transition: {
  ...
  const a = {
    initial: {
      strokeDasharray: "315.7px",
      strokeDashoffset: "315.7px",
    },
    animate: {
      strokeDashoffset: 0,
      transition: {
  ...
  const o = {
    initial: {
      strokeDasharray: "349.4",
      strokeDashoffset: "349.4",
    },
    animate: {
      strokeDashoffset: 0,
      transition: {
  ...
  const n = {
    initial: {
      strokeDasharray: "386.3",
      strokeDashoffset: "386.3",
    },
    animate: {
      strokeDashoffset: 0,
      transition: {
